...
* **`src/02_ingest_pdfs.py`:** Script utilizado para validar la arquitectura. Ejecuta pruebas automatizadas variando parámetros (tamaño de chunk, uso de reranker) para generar las métricas de rendimiento (Hit Rate, MRR, Latencia) presentadas en este documento.
